...
namespace PoliceProjectMVC.Controllers
{
    public class ComplaintController : Controller
    {
        ...
        {
            List<Complaint> complaints = db.Complaints.AsNoTracking().Include(x => x.PoliceStation).ToList();
        ...
        [HttpPost]
        public ActionResult Create(Complaint model)
        {
            ...
            try
            {
                ...
                if (model.MyImage != null && model.MyImage.ContentLength > 0)
                {
                    ...
                    model.ImageUrl = $"/Images/ComplaintImages/{fileName}";
                }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Complaint model = db.Complaints.Find(id);
            if (model == null)
            {
                return HttpNotFound();
            }
